...
import productUnregisterPage from "./product/unregisted/productUnregisterPage";
import productInventoryPage from "./product/inventory/productInventoryPage";
import productPricePage from "./product/price/productPricePage";
  ...
  return (
    <Suspense fallback={<LayoutSplashScreen />}>
      <Switch>
        ...
        <ContentRoute path="/m-shuket/MARTS/marts/product/unregister-list" component={productUnregisterPage} />
        <ContentRoute path="/m-shuket/MARTS/marts/product/inventory-list" component={productInventoryPage} />
        <ContentRoute path="/m-shuket/MARTS/marts/product/price-list" component={productPricePage} />
