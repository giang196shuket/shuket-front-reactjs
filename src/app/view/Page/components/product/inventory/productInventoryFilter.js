...
export function ProductInventoryFilter({ isLoading }) {
          ...
          <form onSubmit={handleSubmit} className="form form-label-right">
            ...
            <div className="form-group row">
              ...
              <FormCheck
                size="large"
                type="checkbox"
                id={values.appStopSaleProduct}
                label={"App stop selling product"}
                checked={values.appStopSaleProduct}
                onChange={(e) => {
                  setFieldValue("appStopSaleProduct", e.target.checked);
                }}
              />
            </div>
            </div>
