import { useOrderUIContext, useMemo }  from './index'


export function OrderGrouping() {
          ...
          <div className="form-group form-group-inline">
            ...
            <div>
              ...
              <button
                ...
                onClick={UIProps.openFetchProductsDialog}
              >
              ...
              <button
                type="button"
                className="btn btn-light-primary font-weight-bolder font-size-sm"
                onClick={UIProps.openUpdateProductsStatusDialog}
              >
